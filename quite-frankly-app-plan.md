...
## Home — decided
- Status strip: "Next show / Live now," links to Watch.
- "Most Recent Show" video card — thumbnail + play-button styling, clicks out to the YouTube video page. Auto-updates via the same RSS/WebSub polling used for new-video notifications.
